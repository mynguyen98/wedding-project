const Languages = {
  ...
  text: {
    ...
    use: 'Sử dụng',
    attend: 'Tính năng',
    enableAttend: 'cho phép khách mời xác nhận có tham dự đám cưới hay không. Chỉ có cô dâu và chú rể xem được tình trạng tham dự và số liệu thống kê khách mời.',
    readChart: 'Cách đọc số liệu thống kê: Nếu đăng nhập bằng tài khoản đã tạo thiệp cưới và nhấn vào xem thiệp cưới, bạn sẽ thấy nút “Xem trạng thái”.',
    guestbook: 'Lưu bút',
